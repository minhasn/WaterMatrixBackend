...
class User {
  static async create({ name, phone_number, city, password, email, country, avatar_url }) {
    ...
    const result = await client.query(
      'INSERT INTO "User" ("name", "phone_number", "city", "password_hash", "email", "country", "avatar_url") VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING "UserId", "name", "email"',
      [name, phone_number, city, password_hash, email, country, avatar_url]
    );
