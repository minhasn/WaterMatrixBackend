    ...
    return new Promise((resolve, reject) => {
      pool.query(
        `INSERT INTO properties (
         UserId, title, description, price, type, address, zipcode, city, bedrooms, washrooms, area, furnished, kitchen, water, electricity, status, category, created_at, updated_at, geometry, IsPaid)
